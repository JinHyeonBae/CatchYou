...
import author3 from "../../../../images/resource/author-3.jpg";
import author4 from "../../../../images/resource/author-4.jpg";
          ...
          <div className="clearfix">
            ...
            <div className="header-left clearfix">
              ...
              <div className="pull-left logo-box">
                ...
                <div className="dark-layout-logo">
                  <a href="index.html">
                    <img src="" alt="" />
                  </a>
                </div>
                  ...
                  <div
                    ...
                    <ul className="navigation clearfix">
                      <li className="dropdown">
                        ...
                        <ul>
                          <li>
                            <a href="featured-courses.html">Featured Courses</a>
                          </li>
                          <li>
                            <a href="latest-courses.html">Latest Courses</a>
                          </li>
                          <li>
                            <a href="category.html">Course Categories</a>
                          </li>
                          <li>
                            <a href="course-detail.html">Course Landing</a>
                          </li>
                          <li>
                      ...
                      <li className="dropdown">
                        ...
                        <ul>
                          <li>
                            <a href="dashboard.html">Instructor Dashboard</a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="team.html">Popular Instructors</a>
                          </li>
                        </ul>
                      </li>
                      <li className="dropdown">
                        ...
                        <ul>
                          <li>
                            <a href="enrolled-courses.html">Enrolled Courses</a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="result.html">Quiz Result</a>
                          </li>
                          <li>
                      ...
                      <li className="dropdown">
                        ...
                        <ul>
                          <li>
                            <a href="price.html">Subscription</a>
                          </li>
                          <li>
                          ...
                          <li>
                            <a href="not-found.html">Error Page</a>
                          </li>
                          <li>
              ...
              <div className="options-box clearfix">
                ...
                <div className="notification-box">
                  <div className="dropdown">
                    <button
                      className="notification-box-btn dropdown-toggle"
                      type="button"
                      id="dropdownMenu"
                      ...
                      <i className="notification-alert" />
                    </button>
                    <div
                ...
                <div className="profile-box dropdown" id="someElementID5">
                  <div className="btn btn-default dropdown-toggle">
                    ...
                    <i className="arrow flaticon-down-arrow" />
                  </div>
                      ...
                      <div className="clearfix">
                        ...
                        <div className="pull-right">
                          ...
                          <ul className="dark-buttons clearfix">
                            <li data-tab="#" className="off">
                              Off
                            </li>
                            <li className="boll">
                              <span className="round" />
                            </li>
                            <li data-tab="#" className="on">
                              On
                            </li>
                          </ul>
                        </div>
